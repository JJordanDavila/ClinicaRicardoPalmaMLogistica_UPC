...
(function ($) {
    ...
    function _bf2(_bf3) {
        ...
        _bf5.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_c19) {
            return _c19;
        }, converter: {
            toPosition: function (_c1a, size) {
                var opts = $(this).slider("options");
